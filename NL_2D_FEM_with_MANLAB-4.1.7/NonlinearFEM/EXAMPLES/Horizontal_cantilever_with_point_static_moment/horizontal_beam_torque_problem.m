function mds = horizontal_beam_problem()
%% Input definition
...
mds.geom.discretisation = [50]; % line 1 discretized with 5 elements
...
mds.force.static.static_ponctual_force_node_list{1} = struct('node', 2,'dof', [3],'amplitude', [1] ); % Fx = -1 and Fy = 0 at node 2
