...
target_mode = 3; % modeto be studied in NNM (autonomous) or in FRF (forced)
...
dispvars = [sys.getcoord('omega') sys.getcoord('cos',7,1);  % -> sys.getcoord('sin', dof_index, harmonic_number)
            sys.getcoord('omega') sys.getcoord('sin',7,1);
            sys.getcoord('omega') sys.getcoord('cos',8,1);
            sys.getcoord('omega') sys.getcoord('sin',8,1)];
