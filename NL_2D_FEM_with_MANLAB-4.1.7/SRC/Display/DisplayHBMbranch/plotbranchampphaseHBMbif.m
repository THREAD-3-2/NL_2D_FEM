...
function Hand = plotbranchampphaseHBMbif(sys,Sec_Diag,Idisp,Hdisp,bifpara_str)
    ...
    function [Hand,Handleg,Leg] = plotsectionHBM(sys,Section,Idisp,Hdisp)
        ...
        for ii=1:Nb
            ...
            if strcmp(Section.Eigen.type,'nothing')
                ...
                text(bifparastab,Ampstab,Section.Eigen.type,'margin',3,'verticalalignment','Bottom')
                box on;
                ...
                text(bifparastab,Phasestab,Section.Eigen.type,'margin',3,'verticalalignment','Bottom')
                box on;
            end
