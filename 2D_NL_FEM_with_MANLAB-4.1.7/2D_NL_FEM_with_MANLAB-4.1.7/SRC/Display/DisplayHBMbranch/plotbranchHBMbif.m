...
function Hand = plotbranchHBMbif(sys,Sec_Diag,Idisp,Hdisp,bifpara_str)
        ...
        for ii=1:Nb
            ...
            if strcmp(Section.Eigen.type,'nothing')
                ...
                if strcmp(Section.Eigen.type,'nothing')
                    ...
                    biftype = Section.Eigen.type;
                end
                text(bifparastab,Hampl_stab,biftype,'margin',3,'verticalalignment','Bottom')
                box on;
            end
